...
{
	return PerspectiveMatrix(1.0f / tan(theta/2), 1.0f / tan(theta/2), zn, zf);
}
...
VECTOR4D Lerp(const VECTOR4D& A, const VECTOR4D& B, float u) //Linear interpolation 
{
